...
// FIX: Tell Express to share your HTML files from this folder
expressApp.use(express.static(__dirname));

// 2. DEFINE YOUR BACKEND ROUTE (Notes Storage)
...
function createWindow() {
  ...
  // FIX: Changed from loadFile to loadURL to support http://
